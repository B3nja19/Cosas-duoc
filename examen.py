...
def comprar(Entradas):
    ...
    try:
        ...
        if eleccion == 2:
            print("**** GOLD ****")
            try:
                numfila = int(input("Ingrese número de fila (1 al 10): "))
                if numfila >= 6 or numfila<= 2:
                    ...
                    ent = numfila - 1
                    asientosdisponibles(Entradas, ent)
                    nrocolumna = int(input("Ingrese número de columna (3 al 5): "))
                    if nrocolumna >= 11 or nrocolumna <=0:
                        print("Error en el ingreso de la opción.")
                        return
                    else:
        ...
        if eleccion == 3:
            ...
            try:
                ...
                if numfila >= 11 or numfila<= 5:
                    ...
                    ent = numfila - 1
                    asientosdisponibles(Entradas, ent)
                    nrocolumna = int(input("Ingrese número de columna (6 al 10): "))
                    if nrocolumna >= 11 or nrocolumna <=0:
                        print("Error en el ingreso de la opción.")
                        return
                    else:
